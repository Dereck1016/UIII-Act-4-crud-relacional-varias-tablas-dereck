...
<?php include_once "encabezado.php" ?>
	<div class="col-xs-12">
		...
		<form method="post" action="guardarDatosEditados.php">
			...
			<input value="<?php echo $producto->cantidadstock ?>" class="form-control" name="cantidadstock" required type="number" id="cantidadstock" placeholder="Numero de Productos en stock">
